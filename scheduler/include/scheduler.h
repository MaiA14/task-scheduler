...
enum sched_func_status {STOP_SCHED, REPEAT_SCHED};
...
/*#############################################################################
  ...
  # Return Value:
	...
	integer number
##############################################################################*/
typedef int (*action_func_task)(void *params);

ilrd_uid_t SchedAddTask(scheduler_t *sched, action_func_task task_action_func, void *params,
